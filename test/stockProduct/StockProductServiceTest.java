...
public class StockProductServiceTest {
    ...
    public void setup() {
        stockProductService =
                Ioc.getInstance().get(IocServices.STOCK_PRODUCT_SERVICE_INSTANCE);
    }
    ...
    public void findById_ShouldReturnOptionalOfStockProduct() {
        ...
        assertEquals(
                newStockProduct, stockProductService.findById(stockProduct.getId()));
    }
    ...
    public void update_ShouldThrowEntityNotFoundException() {
        ...
        var stockProduct =
                StockProductServiceFixtures.buildStockProduct(stockProductExample);
        stockProductService.update(stockProduct);
    }
    ...
    public void update_ShouldReturnUpdatedObject() {
        ...
        var updatedStockProduct =
                StockProductServiceFixtures.buildStockProduct(
                        updatedStockProductExample);
        updatedStockProduct.setId(stockProduct.getId());
        assertEquals(
                newStockProduct, stockProductService.update(updatedStockProduct));
    }
    ...
    public void insert_ShouldReturnOptionalOfStockProduct() {
        var stockProduct = StockProductServiceFixtures.buildStockProduct();
        assertEquals(
                Optional.of(stockProduct), stockProductService.insert(stockProduct));
    }
    ...
    public void delete_ShouldReturnDeletedValue() {
        ...
        var newStockProduct = stockProductService.insert(stockProduct);
        assertEquals(
                newStockProduct, stockProductService.delete(stockProduct.getId()));
    }
