...
public class Ioc {
  ...
  private void registerControllers(Map<String, Object> instanceMap) {
    ...
    instanceMap.put(
        IocControllers.ORDER_TAX_CONTROLLER,
        new OrderTaxController(this.get(IocServices.ORDER_TAX_SERVICE_INSTANCE)));
    instanceMap.put(
        IocControllers.PRODUCT_CONTROLLER,
        new ProductController(this.get(IocServices.PRODUCT_SERVICE_INSTANCE)));
    instanceMap.put(
    ...
    instanceMap.put(
        IocControllers.TAX_CONTROLLER,
        new TaxController(this.get(IocServices.TAX_SERVICE_INSTANCE)));
    instanceMap.put(
        IocControllers.WAITER_CONTROLLER,
        new WaiterController(this.get(IocServices.WAITER_SERVICE_INSTANCE)));
  }
