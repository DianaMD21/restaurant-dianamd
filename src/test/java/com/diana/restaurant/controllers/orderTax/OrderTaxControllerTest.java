...
public class OrderTaxControllerTest {
  ...
  public void getAll_ShouldReturnListOfOrderTaxes() {
    ...
    Mockito.when(orderTaxServiceMock.getAll()).thenReturn(orderTaxes);
    var orderTaxesReturned = orderTaxController.getAll();
    Assertions.assertEquals(orderTaxes, orderTaxesReturned);
