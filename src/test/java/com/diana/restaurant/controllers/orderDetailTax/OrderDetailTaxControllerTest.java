...
public class OrderDetailTaxControllerTest {
  ...
  @Test
  public void getAll_ShouldReturnListOfOrderDetailTaxes() {
    var orderDetailTaxes = OrderDetailTaxServiceFixtures.buildOrderDetailTaxes(3);
    Mockito.when(orderDetailTaxServiceMock.getAll()).thenReturn(orderDetailTaxes);
    var orderDetailTaxesReturned = orderDetailTaxController.getAll();
    Assertions.assertEquals(orderDetailTaxes, orderDetailTaxesReturned);
